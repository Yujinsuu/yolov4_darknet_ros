...
void YoloObjectDetector::init() {
  ...
  nodeHandle_.param("subscribers/camera_reading/topic", cameraTopicName, std::string("/camera1/usb_cam1/image_raw"));
  nodeHandle_.param("subscribers/camera_reading/topic", cameraTopicName, std::string("/camera2/usb_cam2/image_raw"));
